    ...
    public class UserController {
        ...
        @PutMapping("/username")
        public UserResponseDTO updateUsername(@Valid @RequestBody UpdateUsernameDTO dto, Authentication auth) {
            return userService.updateUsername(auth.getName(), dto.getUsername());
        }

        @PutMapping("/email")
        public UserResponseDTO updateEmail(@Valid @RequestBody UpdateEmailDTO dto, Authentication auth) {
            return userService.updateEmail(auth.getName(), dto.getEmail());
        }

        @PutMapping("/password")
        public void updatePassword(@Valid @RequestBody UpdatePasswordDTO dto, Authentication auth) {
